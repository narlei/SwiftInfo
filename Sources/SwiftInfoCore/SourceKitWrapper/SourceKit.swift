...
extension SourceKit {
    ...
    public func sendSync(_ req: SKRequestDictionary) -> SKResult<SKResponseDictionary> {
        log(req.description, sourceKit: true)
        let resp = SKResponse(api.send_request_sync(req.dict), sourcekitd: self)
        log(resp.description, sourceKit: true)
...
public final class SKRequestDictionary: @unchecked Sendable {
    ...
    public init(_ dict: sourcekitd_object_t? = nil, sourcekitd: SourceKit) {
...
public final class SKResponse: @unchecked Sendable {
    ...
    public init(_ response: sourcekitd_response_t?, sourcekitd: SourceKit) {
